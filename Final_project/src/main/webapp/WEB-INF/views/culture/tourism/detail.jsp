		...
		<div class="card mb-2" id="divReplyAdd">
			...
			<div class="card-body">
				<ul class="list-group list-group-flush">
					...
					<button type="button" class="btn btn-dark mt-3" id="replyAdd" class="button_gr">추가</button>
					<button type="button" class="btn btn-dark mt-3" id="replyCancel" class="button_gr">취소</button>
				    </li>
				</ul>
			</div>
		</div>	
		...
		<div class="card mb-2" id="divReplyModify">
			...
			<div class="card-body">
				<ul class="list-group list-group-flush">
					...
					<button type="button" class="btn btn-dark mt-3" id="replyModify" class="button">저장</button>
					<button type="button" class="btn btn-dark mt-3" id="replyModifyCancel" class="button_gr">취소</button>
				    </li>
				</ul>
			</div>
		</div>
